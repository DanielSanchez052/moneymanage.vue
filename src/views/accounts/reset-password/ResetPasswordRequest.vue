...
<div class="flex flex-1 flex-col justify-start py-20">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-white">Recuperar Contraseña?</h2>
    </div>
    ...
    AuthService.resetPasswordRequest(resetPasswordRequest).then(
        (res) => {
            if(!res.success){
                ...
                toast("No se ha podido restaurar tu contraseña", {
                    theme: "dark",
                    type: "error",
                    autoClose: 1000,
                }); // ToastOptions
            ...
            toast("Se te ha enviado un email para restaurar tu contraseña", {
                theme: "dark",
                type: "success",
                autoClose: 1000,
            }); // ToastOptions
