...
import { ref, toRef, defineProps, defineExpose } from "vue"
import UpdateSourceModal from "@/components/sources/UpdateSourceModal.vue"
import UseSources from "@/custom_hooks/sources"

const props = defineProps(["sourcesFilter"])
...
const {
    ...
    isLoading,
    refetch
} = UseSources(token, accountId, sourcesFilter)
