<template>
    <div ref="addTransactionModalId" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <!-- Modal body -->
                <Form @submit="handleAddTransaction" :validation-schema="schema" v-slot="{ errors, isSubmitting }">
                    <div class="">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <Field type="text" name="transactionDate" id="transactionDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Escribe la fecha de la transacción" />
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-2 mb-4">
                            ...
                            <div class="w-full">
                                ...
                                <select id="typeId" name="typeId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <section class="my-2 box-border rounded-sm border-2 p-2">
                            ...
                            <div class="overflow-y-auto max-h-72">
                                <div class="grid grid-rows-1 grid-flow-col gap-2 my-2">
                                    <div>1</div>
                                    <div>2</div>
                                    <div>3</div>
                                </div>
    ...
    const schema = yup.object().shape({
        ammount: yup.number().min(1),
        typeId: yup.string().required(),//.regex(/^\\d+$/g, "the value expected is a number")
    ...
    function handleAddTransaction(transaction, { resetForm }) {
        messages.value = []
        error.value = false
