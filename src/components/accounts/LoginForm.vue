    ...
    methods: {
        handleLogin(user) {
            ...
            this.$store.dispatch("auth/login", user).then(
                () => {
                    let redirect_to = this.$route.query.redirectTo
                    ...
                    this.loading = false
                    this.messages.push(...error.map(e => e.message))
                    this.error = true
                })
        }
    }
